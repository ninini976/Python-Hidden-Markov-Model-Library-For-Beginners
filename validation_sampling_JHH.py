...
# This is a filter that filter out those seqences with only one record
# observations is a list of 1375 sequences
observations = [elem for elem in observations if len(elem)>1]

# remove the diagonosis stage in each of sequences
...
# 		reestimate(hmm1, rand_smpl)
rand_smpl = random.sample(observations,1375)
reestimate(hmm1, rand_smpl)